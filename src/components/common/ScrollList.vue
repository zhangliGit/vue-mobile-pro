    ...
    <div ref = "scrollH">
      ...
      <div class="scroll-up-tip qui-fx fx-ac fx-jc">
        <div v-if="pullDownRefresh">
          <div  v-if="!loadTag">
            <div class="qui-fx fx-ac fx-jc">
              <div class="qui-fx fx-ac" ref="refreshIcon" style="-webkit-transition:all .5s ease;transition:all .5s ease; margin-top: .2rem; -webkit-transform: rotate(180deg);transform: rotate(180deg)"><i class="coicon coicon-jiantou co-fs-3"></i></div>
              <div v-if="upTag == 0" class="qui-fx fx-ac fx-jc">
                <div class="qui-fx fx-ac">下拉刷新</div>
              </div>
              <div v-if="upTag == 1" class="qui-fx fx-ac fx-jc">
                <div class="qui-fx fx-ac">释放刷新</div>
              </div>
            </div>
          </div>
          <div v-if = "loadTag">
      ...
      <div v-show="!isShowData">
        <slot></slot>
        <div v-if = "pullUpLoad">
          <div v-if = "downTag !== -1" class="qui-fx fx-ac co-pd-tb08 fx-jc co-cl-2 co-fs-01 co-bg-0">
            <div v-if="downTag === 1" class="qui-fx fx-ac">
